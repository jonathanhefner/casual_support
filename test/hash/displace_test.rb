...
class HashDisplaceTest < Minitest::Test
  ...
  def test_without_default
    operate_and_assert_invariants(Hash.new)
  end

  def test_with_default
    operate_and_assert_invariants(Hash.new(42))
  end

  private

  def operate_and_assert_invariants(hash)
    [*1..3, *1..3].each_with_index do |key, new_value|
      ...
      if old_value.nil? # stupid fix for MiniTest 6
        assert_nil result
      else
